...
# Create a list met 10 000 elementen
lst = list(range(NUMBER_OF_ELEMENTS))  ##random getallen insteken
random.shuffle(lst)
...
runTime = int((endTime - startTime) * 1000) # Get test time #hoelang het duurt vr elk vn de elementen te vinden in lijst/Set
