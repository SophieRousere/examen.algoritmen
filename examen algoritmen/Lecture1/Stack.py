class Stack: #maakt een nieuw datatype – een eigen soort “object”
    def __init__(self): #__init__ : automatisch aangeroepen bij het maken van een object #self: object zelf
        self.__elements = []   #lege lijst om de stack-items in op te slaan
#De dubbele underscore __ betekent private
#meerdere operaties die bij stack horen
    
    # Return true if the stack is empty
    def isEmpty(self):  #self = het object, elements= elementen uit object
